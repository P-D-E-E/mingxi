        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="pb-12  md:pb-20">
            ...
            <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
              ...
              {/* 1st item */}
              <div className="relative flex flex-col p-6 h-72 bg-white rounded shadow-xl" data-aos="zoom-y-out" data-aos-anchor="[data-aos-id-blocks]">
                ...
                <h3 className="text-xl font-bold leading-snug tracking-tight mb-1">政策咨询</h3>
                <p className="text-gray-600 mb-1">· 国际风险预警简讯</p>
                <p className="text-gray-600 mb-1">· 美国政策动态跟踪解读月报</p>
                <p className="text-gray-600 mb-1">· 全球产业发展动态季报</p>
                <p className="text-gray-600 mb-1">· 研究资料库访问权限</p>
                <p className="text-gray-600 mb-1`">· 中美专家访谈</p>
              </div>

              {/* 2nd item */}
              <div className="relative flex flex-col p-6 h-72 bg-white rounded shadow-xl" data-aos="zoom-y-out" data-aos-delay="150" data-aos-anchor="[data-aos-id-blocks]">
                <svg className="w-12 h-12 mb-3" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
                ...
                <h3 className="text-xl font-bold leading-snug tracking-tight mb-1">出海解决方案</h3>
                <p className="text-gray-600 mb-2">· 全球市场进入/退出风险评估</p>
                <p className="text-gray-600 mb-2">· 专项定制化策略报告</p>
                <p className="text-gray-600 mb-2">· 企业专属顾问，提供战略支持</p>
              </div>

              {/* 3rd item */}
              <div className="relative flex flex-col p-6 h-72 bg-white rounded shadow-xl" data-aos="zoom-y-out" data-aos-delay="300" data-aos-anchor="[data-aos-id-blocks]">
                <svg className="w-12 h-12 mb-3" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
                  <g fill="none" fillRule="evenodd">
                    <circle className="fill-current text-rblue-900" cx="24" cy="24" r="24" />
                    <g strokeWidth="2">
                ...
                <h3 className="text-xl font-bold leading-snug tracking-tight mb-1">中美教育交流</h3>
                
                <p className="text-gray-600 mb-2">· 访问学者项目</p>
                <p className="text-gray-600 mb-2">· 赴美交流项目</p>
                <p className="text-gray-600 mb-2">· 高管教育公开课</p>
                <p className="text-gray-600 mb-2">· 企业储备干部定制化团体培训项目</p>
              </div>
